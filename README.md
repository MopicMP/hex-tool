...
> Hex encode/decode with pretty printing

[![PyPI version](https://badge.fury.io/py/hex-tool.svg)](https://pypi.org/project/hex-tool/)
...
```bash
pip install hex-tool
```

## Quick Start

```python
from hex_tool import tool
